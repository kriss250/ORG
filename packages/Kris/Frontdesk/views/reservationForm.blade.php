...
<div style="padding:6px 10px;" class="row walkin-form-body ">
    ...
    <form id="walkin-form" action="{{action("\Kris\Frontdesk\Controllers\ReservationsController@reserve")}}" method="post">
        <div class="col-xs-4">
            ...
            <fieldset>
                <label>Company</label>
                <input data-display-field="name" data-value-field="idcompanies" data-value-holder="#company_id" type="text" class="suggest-input" data-table="orgdb2.companies" data-field="name" autocomplete="off" name="company" placeholder="Company / Organisation" />
            </fieldset>
