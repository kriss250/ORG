...
class ReservationController extends Controller
{
    ...
    {
        $sql = "select concat_ws(' ',guest.firstname,guest.lastname) as guest,balance_amount,due_amount,username,guest.phone,night_rate,companies.name as company,country,room_number,checkin,checkout from reserved_rooms
...
where reserved_rooms.reservation_id =?";
        ...
        $pays = \DB::connection("mysql_book")->select("select credit,motif,method_name,username from folio
