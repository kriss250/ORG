...
<div class="page"> 
    <div class="thebox">
        ...
        <h1 style="font-family:'Open Sans'">ORG SYSTEMS </h1>
        <p style="margin-bottom: 45px;font-family:'Open Sans'">KLAXYCOM</p>
        <a style="display:none" href="?frontdesk">
            <span>
                ORG
                <i class="fa fa-male"></i>
            </span>Frontdesk
        </a>
        <a href="{{ route('pos') }}?mode=default">
            <span>
                ORG
                <i class="fa fa-cutlery"></i>
            </span>POS
        </a>
        <a href="/frontdesk/standard">
            <span>
                ORG
        ...
        <a style="color:red;" href="{{ route('backoffice') }}">
            <span>
                ORG
                <i class="fa fa-file-text"></i>
            </span>Back Office
    ...
    <ul class="social_icons">
        <li>
            <a href="http://facebook.com/klaxycom/">
