...
<script>
  ...
  var addRow = function (ev)
  {
    ...
    .append($("<td>").html('<button type="button" class="row-del-btn btn btn-danger btn-xs"><i class="fa fa-trash"></i></button>').append(dateInput))
    ...
    <input type="hidden" value="{{csrf_token()}}" name="_token" />
        ...
        <div class="row">
            <div class="col-xs-5">
                ...
                <input required value="{{$invoice->institution}}" class="form-control" type="text" name="company" placeholder="Company Name / Individual" />
                <label>
                    Address / Contacts
                </label>
            ...
            <div class="col-xs-5">
                ...
                <input autocomplete="off" value="{{$invoice->due_date}}" required name="due_date" type="text" style="display:block;max-width:105% !important;width:41% !important" class="form-control date-picker" />

                <label>Delivery Date</label>
                <input autocomplete="off" value="{{$invoice->sent_date}}" name="delivery_date" type="text" style="display:block;max-width:none;width:100% !important" class="form-control date-picker" />
