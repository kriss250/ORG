        ...
        <td>
          <form style="float:right" action="" class="form-inline" method="get">
                ...
                <input type="submit" class="btn btn-success btn-sm" value="Go">
                 <button type="button" data-dates="{{ isset($_GET['startdate']) ? $_GET['startdate'] : date('d/m/Y',strtotime(\ORG\Dates::$RESTODT)) }} - {{ isset($_GET['startdate']) ? $_GET['startdate'] : date('d/m/Y',strtotime(\ORG\Dates::$RESTODT)) }}" data-title="Reprinted Bills Report" class="btn btn-default report-print-btn">Print</button>
           </form> 
        </td>
    </tr>
