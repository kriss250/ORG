            ...
            <tr>
                ...
                <td>
                    <form style="float:right" action="" class="form-inline" method="get">
                        ...
                        <button type="button" data-dates="{{ isset($_GET['startdate']) ? $_GET['startdate'] : date('d/m/Y',strtotime(\ORG\Dates::$RESTODT)) }} - {{ isset($_GET['startdate']) ? $_GET['startdate'] : date('d/m/Y',strtotime(\ORG\Dates::$RESTODT)) }}" data-title="Payment Control" class="btn btn-default report-print-btn">Print</button>
                    </form>
                </td>
            </tr>
