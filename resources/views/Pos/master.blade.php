...
<head>
    ...
    <!--TOUCH MODE-->
    @if(isset($_GET['touch']) && $_GET['touch']==1)
...
<div class="row">
        ...
        <div class="col-md-9 col-xs-9 header-right">
            ...
            <ul>
                ...
                <li>
                    <a href="?touch=1" class="btn btn-xs btn-success touch-switch">
                        <img width="16" src="{{URL('/')}}/assets/images/touch-icon.svg" />
                    </a>
                </li>


                <li>
                    <a href="{{route('pos') }}" class="btn btn-xs btn-danger">POS</a>
                </li>
