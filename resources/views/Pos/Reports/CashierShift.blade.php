           ...
           <form style="float:right" action="" class="form-inline" method="get">
               ...
               <input class="input-sm form-control date-picker" type="text" value="{{ \ORG\Dates::$RESTODATE }}" name="startdate" /> -
                ...
                <input type="submit" class="btn btn-success btn-sm" value="Go">
                 <button type="button" data-dates="{{ isset($_GET['date']) ? $_GET['date'] : date('d/m/Y',strtotime(\ORG\Dates::$RESTODT)) }}" data-title="Cashier Shift Report" class="btn btn-default report-print-btn">Print</button>
           </form> 
        </td>
    </tr>
</table>

    <p class="report-desc"><i class="fa fa-information-circle"></i> Cashier payments summary report.</p>
