...
<ul class="<?php isset($_imported) && $_imported=="1" ? print "menu" : print "dropdown-menu"; ?>">
    ...
    <li>
        <a href="{{action("BackofficeReportController@index","frontofficeArrival$imported") }}">Arrival</a> </li>


    <li>
        <a href="{{action("BackofficeReportController@index","frontofficeExpectedArrival$imported") }}">Expected Arrival</a> </li>
