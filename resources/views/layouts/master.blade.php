...
<!-- Mirrored from www.tattek.sk/minovate-noAngular/layout-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jun 2015 19:52:57 GMT -->
<head>
        ...
        {!! HTML::style('assets/css/vendor/animate.css') !!}
        {!! HTML::style('assets/css/vendor/font-awesome.min.css') !!}
        {!! HTML::style('assets/js/vendor/animsition/assets/css/animsition.min.css') !!}
        ...
        ================= Modernizr ===================
        =========================================== -->
       {!! HTML::script('assets/css/assets/js/vendor/modernizr/modernizr-2.8.3-respond-1.4.2.min.js') !!}
        <!--/ modernizr -->
    ...
    <body id="minovate" class="appWrapper">
            ...
            <section id="content">
                ...
                <div class="page page-fullwidth-layout">
                    ...
                    <div class="pageheader">
                        ...
                        <h2>Full-width Layout <span>// You can place subtitle here</span></h2>
        ...
        <script>window.jQuery || document.write('<script src="assets/assets/js/vendor/jquery/jquery-1.11.2.min.js"><\/script>')</script>
        {!! HTML::script('assets/js/vendor/jquery/jquery-1.11.2.min.js') !!}
        {!! HTML::script('assets/js/vendor/bootstrap/bootstrap.min.js') !!}
        {!! HTML::script('assets/js/vendor/jRespond/jRespond.min.js') !!}
        ...
        {!! HTML::script('assets/js/vendor/animsition/js/jquery.animsition.min.js') !!}
